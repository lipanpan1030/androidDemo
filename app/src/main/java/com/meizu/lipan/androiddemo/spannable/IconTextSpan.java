...
public class IconTextSpan extends ReplacementSpan {
    ...
    private void initDefaultValue(Context context, int bgColorResId, String text) {
        ...
        this.mText = text;
        this.mBgHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20f, mContext.getResources().getDisplayMetrics());
        ...
        this.mTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 15, mContext.getResources().getDisplayMetrics());
    ...
    public void draw(@NonNull Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
        ...
        canvas.drawText(mText, x + mBgWidth / 2,
                bgStartY + (mBgHeight - textRectHeight) / 2 - fontMetrics.top, mTextPaint);
    }
}
